...
export default function MassUpload({params}:{params:{slug:string}}){
  ...
  async function processOne(file:File,id:string){
    ...
    try{
      ...
      await batchApi({action:'item_fail',batch_id:id,client_key:key,error_message:e.message}).catch(()=>{});
      setFailures(v=>[...v,{file,error:e.message}]);
      setFailed(v=>v+1);
    }finally{
